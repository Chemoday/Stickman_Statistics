...
@analytics.route('/popular-weapons')
...
@analytics.route('/popular-armors')
@auth_api_handler.login_required
...
@analytics.route('/richest-users', methods=['GET', 'POST'])
...
@analytics.route('/week-money-gain', methods=['GET', 'POST'])
@auth_api_handler.login_required
